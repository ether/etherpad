...
import {assertPluginCatalogEnabled} from "./pluginCatalogGuard.js";
import {
  checkEngineCompatibility,
  EngineIncompatibleError,
} from './pluginEngineCheck.js';
import {InstallerTaskQueue} from './installerTasks.js';
...
const migratePluginsFromNodeModules = async () => {
  ...
  const [{dependencies = {}}] = JSON.parse(await runCmd(cmd,
      {stdio: [null as any, 'string']}) as any);
